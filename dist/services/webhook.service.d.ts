...
export declare class WebhookService {
    ...
    constructor(options: OmnichannelModuleOptions | undefined, dataSource: DataSource, whatsappAdapter: WhatsAppAdapter, instagramAdapter: InstagramAdapter, omnichannelGateway: OmnichannelGateway | null, conversationService: ConversationService, messageService: MessageService);
