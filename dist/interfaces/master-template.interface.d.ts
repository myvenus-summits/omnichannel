export type ApprovalStatus = 'draft' | 'submitted' | 'approved' | 'rejected' | 'paused' | 'pending' | 'unsubmitted';
...
export interface ITemplateDeploymentRepository {
    ...
    findByMasterTemplateAndClinic(masterTemplateId: number, clinicId: number): Promise<ITemplateDeployment | null>;
    findByTemplateNameAndClinic(templateName: string, clinicId: number): Promise<ITemplateDeployment | null>;
...
export declare const MASTER_TEMPLATE_REPOSITORY = "MASTER_TEMPLATE_REPOSITORY";
export declare const DEPLOYMENT_REPOSITORY = "DEPLOYMENT_REPOSITORY";
//# sourceMappingURL=master-template.interface.d.ts.map